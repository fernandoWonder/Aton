...
namespace Aton.Views.Comercial.Documents
{
    public partial class FrmInvoiceCompra : Form
    {
       ...
       //     searchLookUpProvider.Properties.DataSource = _providerController.view3("");
            ...
            _storageController.ListAllAsNoTracking().ForEach(item => cmbStorage.Properties.Items.Add(item.Armazem));
      ...
      /*  public void toGridEntryProducts()
        ...
        /*
            ...
            {
                idArmazem = _storageController.ListAllAsNoTracking()[cmbStorage.SelectedIndex].Id;
        ...
        private void FrmInvoiceCompra_Load(object sender, EventArgs e)
        {
