...
namespace Aton.Views.Save
{
    public partial class FrmProducts : Form
    {
        ...
        public void toCombosDataInit()
        {
            ...
            _storageController.ListAllAsNoTracking().ForEach(item => cmbArmazem.Properties.Items.Add(item.Id + " - " + item.Armazem));
        ...
        */
        ...
        private void Clear()
        {
            ...
            pictureBox1.Image = Aton.Properties.Resources._default;
            urlImg = null;
        ...
        {
            Storage st = _storageController.ListAllAsNoTracking()[cmbArmazem.SelectedIndex];
        ...
        private void btnSalvar_Click_1(object sender, EventArgs e)
        {
            ...
            else if (idProd != 0)
            {
                ...
                decimal preco1 = txtPreco1.Text.Trim() != "" ? decimal.Parse(txtPreco1.Text.Trim().Replace(".",",")) : 0;
